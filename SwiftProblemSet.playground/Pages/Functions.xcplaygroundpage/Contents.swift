...
func beginsWithVowel(s1: String) -> Bool {
    if s1.characters.count == 0 {
        ...
        return false
    } else if s1.lowercased()[s1.startIndex] == "a" || s1.lowercased()[s1.startIndex] == "e" || s1.lowercased()[s1.startIndex] == "i" || s1.lowercased()[s1.startIndex] == "o" || s1.lowercased()[s1.startIndex] == "u" {
...
output1 = beginsWithVowel(s1: "Apples") // true
output2 = beginsWithVowel(s1: "pIG") // false
output3 = beginsWithVowel(s1: "oink") // true
output4 = beginsWithVowel(s1: "udacity") // true
output5 = beginsWithVowel(s1: "") // false
...
func funWithWords(s1: String) -> String {
    var ot = beginsWithVowel(s1: s1)
    var slcased : String
    if ot == true {
    slcased = s1.uppercased()
        return slcased
    }
    else {
        slcased = s1.lowercased()
        return slcased
    }
}

var strOutput: String
strOutput = funWithWords(s1: "eest")
print(strOutput)
