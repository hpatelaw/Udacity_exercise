...
var gallonRemainingInTank: Double
var ageOfSpecimenInWeeks: Int
let birthPlace: String = "Atlanta"
...
var gallonsRemainingInTank = 0.87
...
///*:
 ...
 let stringToReverse1 = "Mutable or Immutable? That is the question."
 let arrayOfCharacters1 = stringToReverse1.characters.reversed()
 stringToReverse = String(arrayOfCharacters1)
...
var hungryByDays: Int = 4
let winningGameScore: Int = 20
