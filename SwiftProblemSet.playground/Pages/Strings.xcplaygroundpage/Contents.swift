...
totalDollars = (numOfPennies / cents)
var totalCents = (567 % cents)
...
var percentSpentOfIncome = (100 * averageRent) / averageMonthlyEarnings
print("On average, millenials spend \(percentSpentOfIncome)% of their income on rent.")
